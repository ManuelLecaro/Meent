...
type Event struct {
	...
	SpecialFeatures []string  `protobuf:"bytes,7,rep,name=specialFeatures,proto3" json:"specialFeatures,omitempty"`
}
...
func (x *Event) GetSpecialFeatures() []string {
	if x != nil {
...
func (x *Venue) Reset() {
	*x = Venue{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_core_domain_domain_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Venue) Descriptor() ([]byte, []int) {
	return file_internal_core_domain_domain_proto_rawDescGZIP(), []int{1}
}
...
type Ticket struct {
	...
	ShowID   uint64 `protobuf:"varint,4,opt,name=showID,proto3" json:"showID,omitempty"`
...
func (x *Ticket) Reset() {
	*x = Ticket{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_core_domain_domain_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Ticket) Descriptor() ([]byte, []int) {
	return file_internal_core_domain_domain_proto_rawDescGZIP(), []int{2}
}
...
func (x *Ticket) GetShowID() uint64 {
	if x != nil {
		return x.ShowID
	}
	return 0
...
var file_internal_core_domain_domain_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x22, 0xda, 0x01, 0x0a, 0x05,
	...
	,
	...
	0x78, 0x0a, 0x06, 0x54, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x6f, 0x77, 0x6e,
	...
	0x70, 0x72, 0x69, 0x63, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x68, 0x6f, 0x77, 0x49, 0x44, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x73, 0x68, 0x6f, 0x77, 0x49, 0x44, 0x12, 0x1a, 0x0a,
	0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x69, 0x74,
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x4d, 0x61, 0x6e, 0x75, 0x65, 0x6c, 0x4c, 0x65,
	0x63, 0x61, 0x72, 0x6f, 0x2f, 0x6d, 0x69, 0x6e, 0x74, 0x61, 0x70, 0x69, 0x2f, 0x69, 0x6e, 0x74,
	0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_internal_core_domain_domain_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_internal_core_domain_domain_proto_goTypes = []interface{}{
	(*Event)(nil),  // 0: domain.Event
	(*Venue)(nil),  // 1: domain.Venue
	(*Ticket)(nil), // 2: domain.Ticket
}
var file_internal_core_domain_domain_proto_depIdxs = []int32{
	1, // 0: domain.Event.venue:type_name -> domain.Venue
	2, // 1: domain.Event.tickets:type_name -> domain.Ticket
...
func file_internal_core_domain_domain_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_core_domain_domain_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Venue); i {
			case 0:
				return &v.state
			case 1:
		...
		file_internal_core_domain_domain_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Ticket); i {
			case 0:
				return &v.state
			case 1:
